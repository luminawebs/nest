...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"sounds/41.mp3", id:"41"},
		{src:"sounds/audios-41.mp3", id:"41a"},
...
p.nominalBounds = new cjs.Rectangle(0,0,1906,1670);
...
(lib.Símbolo9 = function() {
	...
	this.instance.setTransform(-626.5,-732.5);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-626.5,-732.5,1906,1670);
...
(lib.contenedor = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(383.1,387.3,1,1,0,0,0,325.9,153.2);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:203.2,alpha:1},44,cjs.Ease.get(1)).wait(15));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-569.4,-498.5,1906,1670);
...
(lib.Personajetest2 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var audio3 = createjs.Sound.play("sounds/41.mp3");
...
(lib.Personajehombre = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var audio2 = createjs.Sound.play("sounds/audios-41.mp3");
...
(lib.lip01 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(40).to({_off:false},0).to({x:1056.1},17,cjs.Ease.get(1)).wait(21));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).to({x:159.2},18,cjs.Ease.get(1)).to({_off:true},21).wait(38));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({_off:false},0).to({alpha:0.59},13,cjs.Ease.get(1)).wait(64));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(40).to({_off:false},0).to({alpha:0.48},13,cjs.Ease.get(1)).wait(25));
