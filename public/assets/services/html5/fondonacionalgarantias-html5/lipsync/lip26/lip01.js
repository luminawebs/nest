...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"sounds/30.mp3", id:"30"},
		{src:"sounds/audios-30.mp3", id:"30a"},
...
p.nominalBounds = new cjs.Rectangle(0,0,350,200);
...
p.nominalBounds = new cjs.Rectangle(0,0,780,75);


(lib.Mapadebits1 = function() {
	this.initialize(img.Mapadebits1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,780,373);


(lib.Mapadebits2 = function() {
	this.initialize(img.Mapadebits2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,647,46);


(lib.Mapadebits3 = function() {
	this.initialize(img.Mapadebits3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,665,46);


(lib.Mapadebits4 = function() {
	this.initialize(img.Mapadebits4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,658,46);


(lib.Mapadebits5 = function() {
	this.initialize(img.Mapadebits5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,712,46);


(lib.Mapadebits6 = function() {
	this.initialize(img.Mapadebits6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,684,46);
...
p.nominalBounds = new cjs.Rectangle(-1.5,-1.5,780,373);
...
(lib.Símbolo1 = function() {
	...
	this.instance.setTransform(0,0,0.907,0.907);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,707.3,68);
...
(lib.Path_8 = function() {
	...
	// Capa 1
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#0064A2").p("AAAhfIAAC/");
	this.shape_6.setTransform(0.5,9.6);

	this.addChild(this.shape_6);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-0.5,-1,2,21.3);
...
(lib.ClipGroup = function() {
	...
	mask._off = true;
	mask.graphics.p("AqLCAIAAj/IUXAAIAAD/g");
	mask.setTransform(65.3,37.4);

	// Capa 3
	this.instance = new lib.Image();
	this.instance.setTransform(0,0,0.373,0.373);

	this.instance.mask = mask;

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,24.6,130.6,25.7);
...
(lib.Símbolo3 = function() {
	...
	this.instance.setTransform(88.8,17.9,1,1,0,0,0,65.3,37.3);

	this.instance_1 = new lib.Path_8();
	this.instance_1.setTransform(400.2,19.4,1,1,0,0,0,0.5,9.6);
	this.instance_1.alpha = 0.48;

	this.text = new cjs.Text("Indicadores/Evaluación de Desempeño", "italic 22px 'Calibri'", "#0064A2");
	this.text.lineHeight = 26;
	this.text.setTransform(412.4,3.5);

	this.text_1 = new cjs.Text("Medición del servicio", "italic bold 22px 'Calibri'", "#F66841");
	this.text_1.lineHeight = 26;
	this.text_1.setTransform(193.2,3.5);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Eg6/ADDQgyAAgjgkQgjgjAAgxIAAiUQAAgyAjgjQAjgkAyABMB1/AAAQAygBAjAkQAjAjAAAyIAACUQAAAxgjAjQgjAkgyAAg");
	this.shape.setTransform(389.7,19.5);

	this.addChild(this.shape,this.text_1,this.text,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,-19.4,779.3,74.6);
...
(lib.Símbolo8 = function() {
	...
	this.instance.setTransform(389.7,17.9,1,1,0,0,0,389.7,17.9);
...
(lib.contenedor = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(386.8,-17.5,1,1,0,0,0,353.7,34);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},27,cjs.Ease.get(1)).wait(77));

	// Items
	this.instance_1 = new lib.Símbolo8();
	this.instance_1.setTransform(387.1,125.7,1,1,0,0,0,389.7,17.9);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:0.91,scaleY:0.91,y:-18.6},38,cjs.Ease.get(1)).wait(66));

	// Capa 4
	this.instance_2 = new lib.Símbolo17();
	this.instance_2.setTransform(386,343.1,1,1,0,0,0,388.6,185.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(13).to({_off:false},0).to({regY:185.2,scaleX:0.91,scaleY:0.91,x:386.1,y:178.8,alpha:1},38,cjs.Ease.get(1)).wait(53));

	// Capa 5
	this.instance_3 = new lib.Símbolo11();
	this.instance_3.setTransform(415.2,435.8,1,1,0,0,0,323.4,22.9);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(21).to({_off:false},0).to({scaleX:0.91,scaleY:0.91,x:412.6,y:95.8,alpha:1},38,cjs.Ease.get(1)).wait(45));

	// Capa 6
	this.instance_4 = new lib.Símbolo13();
	this.instance_4.setTransform(406.2,496,1,1,0,0,0,332.4,22.9);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(29).to({_off:false},0).to({scaleX:0.91,scaleY:0.91,x:404.4,y:150.4,alpha:1},38,cjs.Ease.get(1)).wait(37));

	// Capa 7
	this.instance_5 = new lib.Símbolo14();
	this.instance_5.setTransform(409.8,555.1,1,1,0,0,0,328.8,22.9);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(38).to({_off:false},0).to({scaleX:0.91,scaleY:0.91,x:407.7,y:204.1,alpha:1},38,cjs.Ease.get(1)).wait(28));

	// Capa 8
	this.instance_6 = new lib.Símbolo15();
	this.instance_6.setTransform(377.8,614.2,1,1,0,0,0,355.8,22.9);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(47).to({_off:false},0).to({scaleX:0.91,scaleY:0.91,x:378.7,y:257.7,alpha:1},38,cjs.Ease.get(1)).wait(19));

	// Capa 9
	this.instance_7 = new lib.Símbolo16();
	this.instance_7.setTransform(391.5,674.4,1,1,0,0,0,341.9,22.9);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(56).to({_off:false},0).to({regX:342,scaleX:0.91,scaleY:0.91,x:391.2,y:312.3,alpha:1},38,cjs.Ease.get(1)).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2.6,-51.5,779.3,214.5);
...
(lib.Personajehombre = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var audio2 = createjs.Sound.play("sounds/audios-30.mp3");
		...
		function LipsyncH() {
			...
			if (iniciar2) {
				...
				if ((0 <= posicion2  && posicion2 < 300) || (2461 <= posicion2  && posicion2 < 2700) ||  (5240 <= posicion2  && posicion2 < duracion2) ) {
					var_bocah3.alpha = 1; 
				} else {
...
(lib.lip01 = function(mode,startPosition,loop) {
	...
	this.frame_40 = function() {
		...
		var audio1 = createjs.Sound.play("sounds/30.mp3");
		...
		function Lipsync() {
			...
			if (iniciar) {
				...
				if ((0 <= posicion1  && posicion1 < 384) || (2137 <= posicion1  && posicion1 < 2500) ||(4500 <= posicion1  && posicion1 < 4760) ||(8210 <= posicion1  && posicion1 < 8670) || (10317 <= posicion1  && posicion1 < duracion1) ) {
					var_boca3.alpha = 1; 
				} else {
					var azar = Math.floor((Math.random() * 60) + 1);
					if(azar<10){
	...
	this.personajeH.setTransform(1606.7,524.2,0.913,0.913,0,0,0,155.2,408.8);
	this.personajeH._off = true;

	this.timeline.addTween(cjs.Tween.get(this.personajeH).wait(41).to({_off:false},0).to({x:1208.6},25,cjs.Ease.get(1)).wait(12));

	// items
	this.instance = new lib.contenedor();
	this.instance.setTransform(655.2,434,1,1,0,0,0,402.8,290.5);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(16).to({_off:false},0).wait(62));

	// 2
	this.boca2 = new lib.boca2();
	this.boca2.setTransform(110.3,261.9,0.103,0.102,0,5.5,-174.5,144.3,56.3);
	this.boca2.alpha = 0;
	...
	this.boca3.setTransform(110.5,261.9,0.089,0.088,0,5.5,-174.5,163.5,47.3);
	this.boca3.alpha = 0;
	...
	this.boca4.setTransform(111.4,262.6,0.119,0.12,0,1.5,-178.5,107.1,67.1);
	this.boca4.alpha = 0;
	...
	this.boca5.setTransform(111.1,262.6,0.101,0.095,0,5.5,-174.5,143.2,93.4);
	this.boca5.alpha = 0;
	...
	this.boca6.setTransform(111.2,263,0.116,0.115,0,5.5,-174.5,84.3,90.9);
	this.boca6.alpha = 0;
	...
	this.boca7.setTransform(110,263.3,0.109,0.092,0,5.5,-174.5,146.8,83.7);
	this.boca7.alpha = 0;
	...
	this.boca8.setTransform(110.5,259.1,0.949,0.949,0,0,180,20.6,12.1);
	this.boca8.alpha = 0;
	...
	this.ojos_cerrados.setTransform(108.9,226.6,0.949,0.949,0,15,-165,36.5,9);
	...
	this.ceja_derecha.setTransform(-95.2,218.3,0.949,0.949,0,15,-165,15.1,5.5);

	this.timeline.addTween(cjs.Tween.get(this.ceja_derecha).to({x:132.9},28,cjs.Ease.get(1)).wait(50));

	// CejaIzquierda
	this.ceja_izquierda = new lib.ceja_izquierda();
	this.ceja_izquierda.setTransform(-139.2,209.5,0.949,0.949,0,15,-165,15.4,3.6);

	this.timeline.addTween(cjs.Tween.get(this.ceja_izquierda).to({x:88.8},28,cjs.Ease.get(1)).wait(50));

	// Bocas
	this.boca1 = new lib.boca1();
	this.boca1.setTransform(-125.1,265.4,0.949,0.949,0,15,-165,17.5,7);

	this.timeline.addTween(cjs.Tween.get(this.boca1).to({x:103},28,cjs.Ease.get(1)).wait(50));

	// OjosAbiertos
	this.ojos_abiertos = new lib.ojos_abiertos();
	this.ojos_abiertos.setTransform(-119,225.7,0.949,0.949,0,15,-165,36.5,9.1);

	this.timeline.addTween(cjs.Tween.get(this.ojos_abiertos).to({x:109},28,cjs.Ease.get(1)).wait(50));

	// Personaje
	this.personaje = new lib.Símbolo10();
	this.personaje.setTransform(-256.6,138.7,0.828,0.828,0,0,0,0.5,0);

	this.timeline.addTween(cjs.Tween.get(this.personaje).to({x:-28.5},28,cjs.Ease.get(1)).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(41).to({_off:false},0).to({x:1134.2,alpha:0.48},14,cjs.Ease.get(1)).wait(23));

	// personaje
	this.instance_2 = new lib.verde();
	this.instance_2.setTransform(69,405.1,1,1,0,0,0,176.5,195.5);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(41).to({_off:false},0).to({alpha:0.59},12).wait(25));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(451.9,360,1468.2,925.1);
