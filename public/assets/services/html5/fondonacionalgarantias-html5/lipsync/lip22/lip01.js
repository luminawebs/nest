...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"sounds/26.mp3", id:"26"},
		{src:"sounds/audios-26.mp3", id:"26a"},
...
p.nominalBounds = new cjs.Rectangle(0,0,470,175);


(lib.Mapadebits2 = function() {
	this.initialize(img.Mapadebits2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,497,139);


(lib.Mapadebits3 = function() {
	this.initialize(img.Mapadebits3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,99,125);


(lib.Mapadebits4 = function() {
	this.initialize(img.Mapadebits4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,102,125);
...
p.nominalBounds = new cjs.Rectangle(0,0,103,125);
...
p.nominalBounds = new cjs.Rectangle(0,-1,497,139);
...
(lib.contenedor = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(383.3,285.4,1.097,1.097,0,0,0,248.5,68.4);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:68.3,scaleX:0.92,scaleY:0.92,x:383.4,y:183.3,alpha:1},32,cjs.Ease.get(1)).wait(67));

	// Capa 4
	this.instance_1 = new lib.Símbolo2();
	this.instance_1.setTransform(381.2,120.2,1.097,1.097,0,0,0,235.1,66.3);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({_off:false},0).to({scaleX:0.92,scaleY:0.92,x:381.5,y:44.3,alpha:1},32,cjs.Ease.get(1)).wait(52));

	// Items
	this.instance_2 = new lib.Símbolo4();
	this.instance_2.setTransform(175.9,432.3,1.097,1.097,0,0,0,49.5,62.6);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(26).to({_off:false},0).to({scaleX:0.92,scaleY:0.92,x:208.7,y:306.9,alpha:1},32,cjs.Ease.get(1)).wait(41));

	// Capa 8
	this.instance_3 = new lib.Símbolo5();
	this.instance_3.setTransform(314.4,432.3,1.097,1.097,0,0,0,50.9,62.6);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(41).to({_off:false},0).to({scaleX:0.92,scaleY:0.92,x:325.3,y:306.9,alpha:1},32,cjs.Ease.get(1)).wait(26));

	// Capa 7
	this.instance_4 = new lib.Símbolo6();
	this.instance_4.setTransform(451.6,432.3,1.097,1.097,0,0,0,51.1,62.6);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(53).to({_off:false},0).to({scaleX:0.92,scaleY:0.92,x:440.8,y:306.9,alpha:1},32,cjs.Ease.get(1)).wait(14));

	// Capa 6
	this.instance_5 = new lib.Símbolo7();
	this.instance_5.setTransform(588.9,432.3,1.097,1.097,0,0,0,51.4,62.6);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(64).to({_off:false},0).to({scaleX:0.92,scaleY:0.92,x:556.4,y:306.9,alpha:1},32,cjs.Ease.get(1)).wait(3));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(110.7,209.3,545.4,152.5);
...
(lib.Personajetest2 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var audio3 = createjs.Sound.play("sounds/26.mp3");
...
(lib.Personajehombre = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var audio2 = createjs.Sound.play("sounds/audios-26.mp3");
...
(lib.lip01 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(90.1,487.8,0.547,0.547,0,0,0,155.2,408.8);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(40).to({_off:false},0).to({scaleX:0.51,scaleY:0.51,x:306.6,y:475.6},11,cjs.Ease.get(1)).wait(14));

	// personaje-hombre
	this.instance_1 = new lib.Personajehombre();
	this.instance_1.setTransform(1428.5,487.8,0.562,0.562,0,0,0,155.2,408.8);
	this.instance_1._off = true;

	this.instance_2 = new lib.cejashombre();
	this.instance_2.setTransform(1113.3,295.4,0.515,0.515,0,0,0,35.4,5.8);

	this.instance_3 = new lib.ojoshombre();
	this.instance_3.setTransform(1113.6,304.1,0.515,0.515,0,0,0,32.7,7.7);

	this.bocah1 = new lib.bocahombre56();
	this.bocah1.setTransform(1113.3,325.6,0.438,0.394,0,0,0,22.4,10.1);
	this.bocah1.alpha = 0;

	this.bocah2 = new lib.bocah02();
	this.bocah2.setTransform(1113.2,325.5,0.438,0.394,0,0,0,22.6,8.7);
	this.bocah2.alpha = 0;

	this.bocah3 = new lib.bocah03();
	this.bocah3.setTransform(1113.2,326.2,0.438,0.394,0,0,0,10.6,9.7);
	this.bocah3.alpha = 0;

	this.bocah4 = new lib.bocah04();
	this.bocah4.setTransform(1113.5,325.5,0.515,0.515,0,0,0,17.6,6.8);
	this.bocah4.alpha = 0;

	this.bocah5 = new lib.bocah05();
	this.bocah5.setTransform(1113.3,325.1,0.438,0.394,0,0,0,22.4,5);
	this.bocah5.alpha = 0;

	this.bocah6 = new lib.bocah06();
	this.bocah6.setTransform(1113.2,326.1,0.419,0.463,0,0,0,18.7,6.8);
	this.bocah6.alpha = 0;

	this.bocah7 = new lib.bocah07();
	this.bocah7.setTransform(1113.5,325.5,0.515,0.515,0,0,0,13.4,2.7);
	this.bocah7.alpha = 0;

	this.bocah8 = new lib.bocah08();
	this.bocah8.setTransform(1113.4,325.5,0.515,0.515,0,0,0,17.4,7.2);
	this.bocah8.alpha = 0;

	this.bocah9 = new lib.bocah09();
	this.bocah9.setTransform(1113.4,325.6,0.515,0.515,0,0,0,17.9,5.2);
	this.bocah9.alpha = 0;

	this.bocah10 = new lib.bocah10();
	this.bocah10.setTransform(1113.2,325.2,0.515,0.515,0,0,0,14.8,4.3);
	this.bocah10.alpha = 0;

	this.bocah11 = new lib.bocah11();
	this.bocah11.setTransform(1113.4,325.4,0.515,0.515,0,0,0,17.9,3.8);
	this.bocah11.alpha = 0;

	this.bocah12 = new lib.boca01();
	this.bocah12.setTransform(1113.6,324.4,0.515,0.515,0,0,0,23.1,8.8);

	this.instance_4 = new lib.cuerpoh();
	this.instance_4.setTransform(1117.1,484.7,0.554,0.554,0,0,0,155.2,408.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_1}]},14).to({state:[{t:this.instance_4},{t:this.bocah12},{t:this.bocah11},{t:this.bocah10},{t:this.bocah9},{t:this.bocah8},{t:this.bocah7},{t:this.bocah6},{t:this.bocah5},{t:this.bocah4},{t:this.bocah3},{t:this.bocah2},{t:this.bocah1},{t:this.instance_3},{t:this.instance_2}]},25).wait(25));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({_off:false},0).to({x:1117.7},14,cjs.Ease.get(1)).to({_off:true},25).wait(25));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(40).to({_off:false},0).wait(25));

	// bgper01
	this.instance_6 = new lib.verde();
	this.instance_6.setTransform(164.9,412.2,0.448,0.448,0,0,0,176.6,195.6);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(40).to({_off:false},0).to({alpha:0.59},14).wait(11));

	// bgper02
	this.instance_7 = new lib.Group_1();
	this.instance_7.setTransform(1108,425.7,0.448,0.448,0,0,0,177.5,190.4);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1).to({_off:false},0).to({regX:177.6,x:1107.9,alpha:0.48},10,cjs.Ease.get(1)).wait(54));
