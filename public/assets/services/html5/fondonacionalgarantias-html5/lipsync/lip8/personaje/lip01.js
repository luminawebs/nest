...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"sounds/08.mp3", id:"08"},
		{src:"sounds/audios-8.mp3", id:"08a"},
...
(lib.Personajehombre = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var audio2 = createjs.Sound.play("sounds/audios-8.mp3");
...
(lib.lip01 = function(mode,startPosition,loop) {
	...
	this.frame_40 = function() {
		...
		var audio1 = createjs.Sound.play("sounds/08.mp3");
		...
		function Lipsync() {
			...
			if (iniciar) {
				...
				if ((0 <= posicion1  && posicion1 < 236) || (600 <= posicion1  && posicion1 < 854) ||(931 <= posicion1  && posicion1 < 1074) ||(1846 <= posicion1  && posicion1 < 2000) || (4574 <= posicion1  && posicion1 < duracion1) ) {
					var_boca3.alpha = 1; 
				} else {
					var azar = Math.floor((Math.random() * 60) + 1);
					if(azar<10){
	...
	this.personajeH.setTransform(-285.6,570.8,1.103,1.103,0,0,180,155.2,408.8);
	this.personajeH._off = true;

	this.timeline.addTween(cjs.Tween.get(this.personajeH).wait(41).to({_off:false},0).to({x:122.5},25,cjs.Ease.get(1)).wait(12));

	// personaje
	this.instance = new lib.verde();
	this.instance.setTransform(69,405.1,1,1,0,0,0,176.5,195.5);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(41).to({_off:false},0).to({alpha:0.59},12).wait(25));

	// 2
	this.boca2 = new lib.boca2();
	this.boca2.setTransform(1161.6,253.9,0.124,0.124,-5.5,0,0,144.5,55.9);
	this.boca2.alpha = 0;
	...
	this.boca3.setTransform(1161.4,253.8,0.108,0.107,0,-5.5,-5.5,163.1,46.6);
	this.boca3.alpha = 0;
	...
	this.boca4.setTransform(1160.3,254.7,0.144,0.145,-1.5,0,0,107.4,66.8);
	this.boca4.alpha = 0;
	...
	this.boca5.setTransform(1160.6,254.7,0.122,0.114,-5.5,0,0,143.2,93);
	this.boca5.alpha = 0;
	...
	this.boca6.setTransform(1160.6,255.3,0.14,0.139,-5.5,0,0,84.5,90.8);
	this.boca6.alpha = 0;
	...
	this.boca7.setTransform(1162,255.6,0.132,0.111,-5.5,0,0,147.3,84.5);
	this.boca7.alpha = 0;
	...
	this.boca8.setTransform(1161.4,250.6,1.147,1.147,0,0,0,20.6,12.2);
	this.boca8.alpha = 0;
	...
	this.ojos_cerrados.setTransform(1163.4,211.2,1.147,1.147,-15,0,0,36.5,9);
	...
	this.ceja_derecha.setTransform(1398.5,201.2,1.147,1.147,-15,0,0,15.1,5.5);

	this.timeline.addTween(cjs.Tween.get(this.ceja_derecha).to({x:1134.4},28,cjs.Ease.get(1)).wait(50));

	// CejaIzquierda
	this.ceja_izquierda = new lib.ceja_izquierda();
	this.ceja_izquierda.setTransform(1451.6,190.8,1.147,1.147,-15,0,0,15.3,3.7);

	this.timeline.addTween(cjs.Tween.get(this.ceja_izquierda).to({x:1187.5},28,cjs.Ease.get(1)).wait(50));

	// Bocas
	this.boca1 = new lib.boca1();
	this.boca1.setTransform(1434.4,258.2,1.147,1.147,-15,0,0,17.4,7);

	this.timeline.addTween(cjs.Tween.get(this.boca1).to({x:1170.4},28,cjs.Ease.get(1)).wait(50));

	// OjosAbiertos
	this.ojos_abiertos = new lib.ojos_abiertos();
	this.ojos_abiertos.setTransform(1427.2,210.1,1.147,1.147,-15,0,0,36.5,9);

	this.timeline.addTween(cjs.Tween.get(this.ojos_abiertos).to({x:1163.1},28,cjs.Ease.get(1)).wait(50));

	// Personaje
	this.personaje = new lib.Símbolo10();
	this.personaje.setTransform(1593.4,105,1,1,0,0,180,0.5,0);

	this.timeline.addTween(cjs.Tween.get(this.personaje).to({x:1329.3},28,cjs.Ease.get(1)).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(25).to({_off:false},0).to({x:1134.2,alpha:0.48},14,cjs.Ease.get(1)).wait(39));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(640,360,1510.7,1055.1);
