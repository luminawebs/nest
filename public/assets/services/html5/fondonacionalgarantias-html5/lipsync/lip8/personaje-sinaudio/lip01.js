...
(lib.Personajehombre = function() {
	...
	this.addChild(this.instance_2,this.bocah12,this.bocah11,this.bocah10,this.bocah9,this.bocah8,this.bocah7,this.bocah6,this.bocah5,this.bocah4,this.bocah3,this.bocah2,this.bocah1,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
...
(lib.lip01 = function(mode,startPosition,loop) {
	...
	this.personajeH.setTransform(122.5,570.8,1.103,1.103,0,0,180,155.2,408.8);

	this.timeline.addTween(cjs.Tween.get(this.personajeH).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.boca2).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.boca3).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.boca4).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.boca5).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.boca6).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.boca7).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.boca8).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.ojos_cerrados).wait(1));

	// CejaDerecha
	this.ceja_derecha = new lib.ceja_derecha();
	this.ceja_derecha.setTransform(1134.4,201.2,1.147,1.147,-15,0,0,15.1,5.5);

	this.timeline.addTween(cjs.Tween.get(this.ceja_derecha).wait(1));

	// CejaIzquierda
	this.ceja_izquierda = new lib.ceja_izquierda();
	this.ceja_izquierda.setTransform(1187.5,190.8,1.147,1.147,-15,0,0,15.3,3.7);

	this.timeline.addTween(cjs.Tween.get(this.ceja_izquierda).wait(1));

	// Bocas
	this.boca1 = new lib.boca1();
	this.boca1.setTransform(1170.4,258.2,1.147,1.147,-15,0,0,17.4,7);

	this.timeline.addTween(cjs.Tween.get(this.boca1).wait(1));

	// OjosAbiertos
	this.ojos_abiertos = new lib.ojos_abiertos();
	this.ojos_abiertos.setTransform(1163.1,210.1,1.147,1.147,-15,0,0,36.5,9);

	this.timeline.addTween(cjs.Tween.get(this.ojos_abiertos).wait(1));

	// Personaje
	this.personaje = new lib.Símbolo10();
	this.personaje.setTransform(1329.3,105,1,1,0,0,180,0.5,0);

	this.timeline.addTween(cjs.Tween.get(this.personaje).wait(1));

	// Capa 4
	this.instance_1 = new lib.Group_1();
	this.instance_1.setTransform(1134.2,435.5,1,1,0,0,0,177.5,190.5);
	this.instance_1.alpha = 0.48;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(532.5,360,1419.2,1055.1);
