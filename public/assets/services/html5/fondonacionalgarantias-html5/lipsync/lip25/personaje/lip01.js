...
(lib.lip01 = function(mode,startPosition,loop) {
	...
	this.frame_24 = function() {
		...
		var audio1 = createjs.Sound.play("sounds/29.mp3");
		...
		function Lipsync() {
			...
			if (iniciar) {
				...
				if ((0 <= posicion1  && posicion1 < 351) || (2351 <= posicion1  && posicion1 < 2629) ||(4400 <= posicion1  && posicion1 < 4600) ||(8000 <= posicion1  && posicion1 < 8500) || (11200 <= posicion1  && posicion1 < 11500) || (12600 <= posicion1  && posicion1 < 13000) || (16600 <= posicion1  && posicion1 < 17000) ||(21800 <= posicion1  && posicion1 < duracion1) ) {
					var_boca3.alpha = 1; 
				} else {
	...
	this.boca2.setTransform(1104.2,259.9,0.143,0.142,0,5.5,-174.5,143.6,55.6);
	this.boca2.alpha = 0;
	...
	this.boca3.setTransform(1104.4,259.9,0.125,0.123,0,5.5,-174.4,163,46.7);
	this.boca3.alpha = 0;
	...
	this.boca4.setTransform(1105.6,260.8,0.166,0.167,0,1.6,-178.4,107.6,66.2);
	this.boca4.alpha = 0;
	...
	this.boca5.setTransform(1105.3,260.9,0.14,0.132,0,5.5,-174.5,142.3,93.3);
	this.boca5.alpha = 0;
	...
	this.boca6.setTransform(1105.4,261.6,0.161,0.16,0,5.5,-174.4,84,90.9);
	this.boca6.alpha = 0;
	...
	this.boca7.setTransform(1103.8,262,0.152,0.128,0,5.5,-174.4,147,84.3);
	this.boca7.alpha = 0;
	...
	this.boca8.setTransform(1104.4,256.3,1.322,1.322,0,0,180,20.6,12.2);
	this.boca8.alpha = 0;
	...
	this.ojos_cerrados.setTransform(1102.1,210.8,1.322,1.322,0,15,-165,36.5,9);
	...
	this.ceja_derecha.setTransform(1630.8,209,1.322,1.322,0,10,-170,14.9,5.4);

	this.timeline.addTween(cjs.Tween.get(this.ceja_derecha).to({regX:15,regY:5.5,skewX:15,skewY:-165,x:1135.7,y:199.2},23,cjs.Ease.get(1)).wait(2));

	// CejaIzquierda
	this.ceja_izquierda = new lib.ceja_izquierda();
	this.ceja_izquierda.setTransform(1568.6,203.5,1.322,1.322,0,10,-170,15.5,3.5);

	this.timeline.addTween(cjs.Tween.get(this.ceja_izquierda).to({regY:3.8,skewX:15,skewY:-165,x:1074.2,y:187.3},23,cjs.Ease.get(1)).wait(2));

	// Bocas
	this.boca1 = new lib.boca1();
	this.boca1.setTransform(1589.6,277.2,1.322,1.322,0,10,-170,17.6,7);

	this.timeline.addTween(cjs.Tween.get(this.boca1).to({regX:17.4,regY:6.9,skewX:15,skewY:-165,x:1094.1,y:264.8},23,cjs.Ease.get(1)).wait(2));

	// OjosAbiertos
	this.ojos_abiertos = new lib.ojos_abiertos();
	this.ojos_abiertos.setTransform(1597.8,220.9,1.322,1.322,0,10,-170,36.5,9);

	this.timeline.addTween(cjs.Tween.get(this.ojos_abiertos).to({regY:9.1,skewX:15,skewY:-165,x:1102.4,y:209.6},23,cjs.Ease.get(1)).wait(2));

	// Personaje
	this.personaje = new lib.Símbolo10();
	this.personaje.setTransform(1805.6,47,1.322,1.322,0,0,180,0.5,0);

	this.timeline.addTween(cjs.Tween.get(this.personaje).to({x:1312.2,y:36.4},23,cjs.Ease.get(1)).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(1942.5,495.6,446.8,605.5);
