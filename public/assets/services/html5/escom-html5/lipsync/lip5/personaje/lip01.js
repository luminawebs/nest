...
(lib.Intrucción = function() {
	this.initialize(img.Intrucción);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,456,23);
...
(lib.Título = function() {
	this.initialize(img.Título);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,722,84);
...
(lib.it03 = function() {
	...
	// Capa 1
	this.instance = new lib.Intrucción();
...
(lib.lip01 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		var items = [this.it00, this.it01, this.it02, this.it03]
	...
	this.it03.setTransform(743,668.5,1,1,0,0,0,228,11.5);

	this.it02 = new lib.it02();
	this.it02.setTransform(663,219,1,1,0,0,0,361,42);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.it02},{t:this.it03}]}).wait(1));
	...
	this.it00.setTransform(502.1,676.3,1.222,1.222,180,0,0,640,400);

	this.timeline.addTween(cjs.Tween.get(this.it00).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(244.8,222,1990.2,1243.8);
