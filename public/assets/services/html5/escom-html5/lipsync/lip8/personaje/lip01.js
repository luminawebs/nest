...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/Sintítulo2.jpg", id:"Sintítulo2"}
	]
};
...
(lib.Sintítulo2 = function() {
	this.initialize(img.Sintítulo2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,949,531);
...
(lib.it033 = function() {
	...
	// Capa 1
	this.instance = new lib.Sintítulo2();
...
(lib.it06 = function() {
	...
	// Capa 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.Lineas, null, new cjs.Matrix2D(-1.272,0,0,-1.272,293.4,508.8)).s().p("Egt0BPfMAAAie9MBbpAAAMAAACe9g");
	this.shape.setTransform(1080.7,590.1);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(787.3,81.4,586.8,1017.6);
...
(lib.lip01 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		var items = [this.it00, this.it01, this.it02]
	...
	this.it01.setTransform(142.1,479.8,1.138,1.141,0,0,180,88.2,203.7);

	this.timeline.addTween(cjs.Tween.get(this.it01).wait(1));

	// Capa 1
	this.it02 = new lib.it033();
	this.it02.setTransform(752.5,426.5,1,1,0,0,0,474.5,265.5);

	this.timeline.addTween(cjs.Tween.get(this.it02).wait(1));

	// Capa 34
	this.it00 = new lib.it06();
	this.it00.setTransform(400.1,266.2,1.222,1.222,0,0,0,640,400);

	this.timeline.addTween(cjs.Tween.get(this.it00).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(640,276.7,1297.4,1243.8);
