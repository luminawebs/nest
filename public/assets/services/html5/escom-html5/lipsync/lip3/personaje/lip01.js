...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/Contenidos.png", id:"Contenidos"},
		{src:"images/infoconfi.png", id:"infoconfi"},
		{src:"images/Lineas.png", id:"Lineas"},
		{src:"images/Objetointeligentevectorial.png", id:"Objetointeligentevectorial"},
		{src:"images/Thief.png", id:"Thief"}
	]
};
...
(lib.Contenidos = function() {
	this.initialize(img.Contenidos);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,363,313);


(lib.infoconfi = function() {
	this.initialize(img.infoconfi);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,347,123);
...
(lib.Thief = function() {
	this.initialize(img.Thief);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,948,544);
...
(lib.it04 = function() {
	...
	// Capa 1
	this.instance = new lib.infoconfi();
...
(lib.it03 = function() {
	...
	// Capa 1
	this.instance = new lib.Contenidos();
...
(lib.lip01 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		var items = [this.it00, this.it01, this.it02, this.it03, this.it04]
	...
	this.it04.setTransform(762,226.5,1,1,0,0,0,173.5,61.5);

	this.it03 = new lib.it03();
	this.it03.setTransform(929,482,1,1,0,0,0,181.5,156.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.it03},{t:this.it04}]}).wait(1));

	// Capa 3
	this.it02 = new lib.it02();
	this.it02.setTransform(739,411.7,1,1,0,0,0,474,272);
	...
	this.it00.setTransform(-610.2,800.4,1.624,1.624,180,0,0,640,400);

	this.timeline.addTween(cjs.Tween.get(this.it00).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1162.5,65.1,3082.5,1652.8);
