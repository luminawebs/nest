...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/BASADAENCOMPUTADORASPhishing.png", id:"BASADAENCOMPUTADORASPhishing"},
		{src:"images/BASADAENCONTACTOHUMANOPresencialTelefónicoEtc.png", id:"BASADAENCONTACTOHUMANOPresencialTelefónicoEtc"},
		{src:"images/CONCEPTOSPRIMORDIALES.png", id:"CONCEPTOSPRIMORDIALES"},
		{src:"images/Conjuntodetécnicaspsicológicasyhabilidadessocialestales.png", id:"Conjuntodetécnicaspsicológicasyhabilidadessocialestales"},
		{src:"images/Grupo5.png", id:"Grupo5"},
		{src:"images/Lineas.png", id:"Lineas"},
		{src:"images/Objetointeligentevectorial.png", id:"Objetointeligentevectorial"},
		{src:"images/Verconversacion.png", id:"Verconversacion"}
	]
};
...
(lib.BASADAENCOMPUTADORASPhishing = function() {
	this.initialize(img.BASADAENCOMPUTADORASPhishing);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,158,83);


(lib.BASADAENCONTACTOHUMANOPresencialTelefónicoEtc = function() {
	this.initialize(img.BASADAENCONTACTOHUMANOPresencialTelefónicoEtc);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,192,102);


(lib.CONCEPTOSPRIMORDIALES = function() {
	this.initialize(img.CONCEPTOSPRIMORDIALES);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,372,74);


(lib.Conjuntodetécnicaspsicológicasyhabilidadessocialestales = function() {
	this.initialize(img.Conjuntodetécnicaspsicológicasyhabilidadessocialestales);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,478,163);


(lib.Grupo5 = function() {
	this.initialize(img.Grupo5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,509,190);
...
(lib.Objetointeligentevectorial = function() {
	this.initialize(img.Objetointeligentevectorial);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1046,626);


(lib.Verconversacion = function() {
	this.initialize(img.Verconversacion);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,363,505);
...
(lib.it08 = function() {
	...
	// Capa 1
	this.instance = new lib.Verconversacion();
...
(lib.it05 = function() {
	...
	// Capa 1
	this.instance = new lib.BASADAENCONTACTOHUMANOPresencialTelefónicoEtc();
...
(lib.it04 = function() {
	...
	// Capa 1
	this.instance = new lib.BASADAENCOMPUTADORASPhishing();
...
(lib.it03 = function() {
	...
	// Capa 1
	this.instance = new lib.Conjuntodetécnicaspsicológicasyhabilidadessocialestales();
...
(lib.it02 = function() {
	...
	// Capa 1
	this.instance = new lib.CONCEPTOSPRIMORDIALES();
...
(lib.it01 = function() {
	...
	// Capa 1
	this.instance = new lib.Objetointeligentevectorial();
...
(lib.lip01 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		var items = [this.it00, this.it01, this.it02, this.it03, this.it04, this.it05, this.it06, this.it07]
		
		
		var tl = new TimelineMax();
		
		tl.staggerFrom(items, 1.8, {alpha:0, y:"+=300px", ease:Back.easeOut}, 0.8);
	}
	...
	this.instance.setTransform(130.1,493.8,1.138,1.141,0,0,180,88.2,203.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Capa 1
	this.it07 = new lib.it08();
	this.it07.setTransform(1009.2,424.7,1,1,0,0,0,181.5,252.5);

	this.it06 = new lib.it05();
	this.it06.setTransform(665.2,567.2,1,1,0,0,0,96,51);

	this.it05 = new lib.it04();
	this.it05.setTransform(394.2,557.7,1,1,0,0,0,79,41.5);

	this.it03 = new lib.it03();
	this.it03.setTransform(544.2,365.1,1,1,0,0,0,239,81.5);

	this.it02 = new lib.it02();
	this.it02.setTransform(491.2,224.3,1,1,0,0,0,186,37);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.it02},{t:this.it03},{t:this.it05},{t:this.it06},{t:this.it07}]}).wait(1));

	// Capa 2
	this.it04 = new lib.it07();
	this.it04.setTransform(529.1,577.2,1,1,0,0,0,254.5,95);

	this.it01 = new lib.it01();
	this.it01.setTransform(705.2,445.2,1,1,0,0,0,523,313);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.it01},{t:this.it04}]}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(571.9,58.8,2644.5,1652.8);
