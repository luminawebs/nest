...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/bgsitems.png", id:"bgsitems"},
		{src:"images/it01.png", id:"it01"},
		{src:"images/it02.png", id:"it02"},
		{src:"images/it03.png", id:"it03"},
		{src:"images/it04.png", id:"it04"},
		{src:"images/kevinmitnickspeakerprofile.png", id:"kevinmitnickspeakerprofile"},
...
p.nominalBounds = new cjs.Rectangle(0,0,21,216);


(lib.bgsitems = function() {
	this.initialize(img.bgsitems);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,368);


(lib.it01 = function() {
	this.initialize(img.it01);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,428,41);


(lib.it02 = function() {
	this.initialize(img.it02);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,423,37);


(lib.it03 = function() {
	this.initialize(img.it03);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,427,38);


(lib.it04 = function() {
	this.initialize(img.it04);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,425,33);


(lib.kevinmitnickspeakerprofile = function() {
	this.initialize(img.kevinmitnickspeakerprofile);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,447,520);
...
p.nominalBounds = new cjs.Rectangle(0,0,473,95);
...
(lib.it06 = function() {
	...
	this.instance.setTransform(175.3,1148.7,0.802,0.802,-90);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(175.3,122.5,641.3,1026.2);
...
(lib.it04_1 = function() {
	...
	// Capa 1
	this.instance = new lib.bgsitems();
...
(lib.it03_1 = function() {
	...
	// Capa 1
	this.instance = new lib.kevinmitnickspeakerprofile();
...
(lib.lip01 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var items2 = [this.it06, this.it07, this.it08, this.it09]
		
		
		var tl = new TimelineMax();
		
		tl.staggerFrom(items, 1.8, {alpha:0, y:"+=300px", ease:Back.easeOut}, 0.8);
		tl.staggerFrom(items2, 1.8, {alpha:0, x:"+=300px", ease:Back.easeOut}, 0.8);
	}
	...
	// Capa 1
	this.it09 = new lib.it10();
	this.it09.setTransform(542.5,617.5,1,1,0,0,0,212.5,16.5);

	this.it08 = new lib.it09();
	this.it08.setTransform(543.5,526,1,1,0,0,0,213.5,19);

	this.it07 = new lib.it08();
	this.it07.setTransform(541.5,429.5,1,1,0,0,0,211.5,18.5);

	this.it06 = new lib.it07();
	this.it06.setTransform(544,328.5,1,1,0,0,0,214,20.5);

	this.it05 = new lib.it05();
	this.it05.setTransform(540.1,475.2,1,1,0,0,0,10.5,108);

	this.it03 = new lib.it03_1();
	this.it03.setTransform(1023.2,429.2,1,1,0,0,0,223.5,260);

	this.it02 = new lib.it02_1();
	this.it02.setTransform(540.5,223.5,1,1,0,0,0,236.5,47.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.it02},{t:this.it03},{t:this.it05},{t:this.it06},{t:this.it07},{t:this.it08},{t:this.it09}]}).wait(1));

	// Capa 3
	this.it04 = new lib.it04_1();
	this.it04.setTransform(539.2,479.2,1,1,0,0,0,240,184);

	this.timeline.addTween(cjs.Tween.get(this.it04).wait(1));

	// Capa 2
	this.it01 = new lib.it01_1();
	...
	this.it00.setTransform(572.1,800.4,1.624,1.624,180,0,0,640,400);

	this.timeline.addTween(cjs.Tween.get(this.it00).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(640,-15.8,1326.9,1666.9);
