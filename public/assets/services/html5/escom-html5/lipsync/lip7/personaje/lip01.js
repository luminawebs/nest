...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/Sintítulo1.png", id:"Sintítulo1"}
	]
};
...
(lib.Sintítulo1 = function() {
	this.initialize(img.Sintítulo1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,124,359);
...
(lib.it04 = function() {
	...
	// Capa 1
	this.instance = new lib.Sintítulo1();
...
(lib.lip01 = function(mode,startPosition,loop) {
	...
	this.it01.setTransform(235.1,403.9,0.773,0.76,0,0,180,88.3,203.7);

	this.timeline.addTween(cjs.Tween.get(this.it01).wait(1));

	// Capa 1
	this.it02 = new lib.it04();
	this.it02.setTransform(235.5,374.5,1,1,0,0,0,62,179.5);
